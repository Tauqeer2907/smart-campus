      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <h1 className="text-3xl font-bold tracking-tight text-foreground">
            Hostel Maintenance <span className="text-primary">Hub</span>
          </h1>
                ...
                <div className="space-y-2">
                  ...
                  <div 
                    className={`border-2 border-dashed rounded-xl p-6 transition-all cursor-pointer flex flex-col items-center justify-center gap-2 ${
                      selectedFile ? 'border-primary bg-primary/5' : 'border-white/10 hover:border-primary/40 hover:bg-primary/5'
                    }`}
                          ...
                          {ticket.steps.map((step, i) => (
                            <div 
                              ...
                              className={`flex flex-col items-center gap-2 ${
                                i <= ticket.currentStep ? 'text-primary' : 'text-muted-foreground/50'
                              }`}
                            >
                              <div className={`w-2 h-2 rounded-full ${
                                i <= ticket.currentStep ? 'bg-primary shadow-[0_0_8px_rgba(59,130,246,0.5)]' : 'bg-muted'
                              }`} />
                              {step}
                            </div>
                          ))}
